...
if __name__ == "__main__":
    ...
    while (1):
        ...
        while (1):
            ...
            if argument == 1:
                web = input(" unique website/source name : ") + " "  + p1.random_char(2) + p1.line_count()   #site we want to save
                ...
                if(save_generated_password =="1"):
                    ...
                    web = input(" unique website/source name : ") + " "  + p1.random_char(2) + p1.line_count() 
                    '''wdata = p1.save_website()
